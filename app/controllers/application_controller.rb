...
class ApplicationController < ActionController::Base
  ...
  def multidao_redirect
    ...
    catarse = Site.find_by_path "catapulta"
  ...
  def current_site
    ...
    @current_site = Site.find_by_path("catapulta") unless @current_site
    @current_site = Factory(:site, :name => "Catarse", :path => "catapulta") unless @current_site
    @current_site
  end
  def current_user
